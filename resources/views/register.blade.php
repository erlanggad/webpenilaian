                ...
                <div class="main-mockup">
                    ...
                    <div class="content-wthree">
                        ...
                        <form class="form" action="/store-register" method="post">
                            @csrf
                            <input type="text" class="nama_karyawan" name="nama_karyawan" placeholder="Masukkan Nama"
                                required>
                            <input type="text" class="nik" name="nik" placeholder="Masukkan NIK" required>
                            <input type="text" class="tanggal_lahir" name="tanggal_lahir"
                                placeholder="Tanggal Mulai Bekerja" onblur="if(this.value==''){this.type='text'}"
                            ...
                            <input type="text" name="unit" placeholder="Masukkan Unit Kerja" id=""
                                required>
                            <br>
