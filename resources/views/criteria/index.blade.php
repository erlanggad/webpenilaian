    ...
    <h3>Kriteria</h3>
        ...
        <div class="page-content">
            <section class="row">
              ...
              @csrf --}}
                            <a class="btn btn-outline-success btn-sm m-2 ms-4" href="/admin/kriteria/create">
                                Tambah Kriteria
                            </a>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <form action="{{ route('kriteria.destroy', $criteria->id) }}"
                                                    ...
                                                    @csrf
                                                    @method('DELETE')
                                                    <a href="{{ route('kriteria.edit', ['kriterium' => $criteria->id]) }}"
        ...
        <div class="modal fade text-left" id="inlineForm" tabindex="-1" role="dialog" aria-labelledby="myModalLabel33"
            ...
            <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable" role="document">
              ...
              <input type="text" name="weight" class="form-control" hidden>
                            ...
                            <div class="form-group">
                                <input type="text" name="information" placeholder="Information Name" class="form-control"
                                    required>
                            </div>
                            <div class="form-group">
