                ...
                <ul class="nav" id="side-menu">
                    ...
                    @if (Session('user')['role'] == 'admin')
                        ...
                        <li> <a href="/admin/manage-karyawan" class="waves-effect "><i
                                    class="zmdi zmdi-account zmdi-hc-fw fa-fw"></i> <span class="hide-menu"> Kelola
                                    Karyawan </span></a></li>
                        <li> <a href="/admin/ranking" class="waves-effect ">
                    ...
                    @elseif (Session('user')['role'] == 'Direktur')
                        <li> <a href="/direktur/home" class="waves-effect "><i
                                    class="zmdi zmdi-view-dashboard zmdi-hc-fw fa-fw"></i> <span class="hide-menu">
                                    Home
                                </span></a></li>
                        <li> <a href="/direktur/manage-karyawan" class="waves-effect "><i
                                    class="zmdi zmdi-account zmdi-hc-fw fa-fw"></i> <span class="hide-menu"> Kelola
                                    Karyawan </span></a></li>
                        <li> <a href="/direktur/ranking" class="waves-effect ">
                                <i class="zmdi zmdi-account zmdi-hc-fw fa-fw"></i> <span class="hide-menu">Ranking
                                    Penilaian Kinerja </span>
                            </a>
                        </li>
                    ...
                    @elseif (Session('user')['role'] == 'Kepala Sub Bagian')
                        ...
                        <li> <a href="/kepala-sub-bagian/form-penilaian-saya" class="waves-effect "><i
                                    class="zmdi zmdi-account zmdi-hc-fw fa-fw"></i> <span class="hide-menu"> Form
                                    Penilaian Saya </span></a></li>
                    @elseif (Session('user')['role'] == 'karyawan' || Session('user')['role'] == 'Karyawan')
                        <li> <a href="/karyawan/home" class="waves-effect "><i
                                    class="zmdi zmdi-view-dashboard zmdi-hc-fw fa-fw"></i> <span class="hide-menu">
                                    Home </span></a></li>
                        <li> <a href="/karyawan/form-penilaian-saya" class="waves-effect "><i
                                    class="zmdi zmdi-account zmdi-hc-fw fa-fw"></i> <span class="hide-menu"> Form
                                    Penilaian Saya </span></a></li>
                    @endif
