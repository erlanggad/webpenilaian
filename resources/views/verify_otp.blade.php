            ...
            <div class="workinghny-form-grid">
                <div class="main-mockup">
                    ...
                    <div class="content-wthree">
                        <center><h2>Masukkan Kode Otp</h2></center>
                        <form id="loginform" action="/verify-otp-action" method="post">
                            @csrf
                    ...
                    @endif --}}
                            <input type="number" class="otp" name="otp" placeholder="Masukkan Otp" required min="0">
