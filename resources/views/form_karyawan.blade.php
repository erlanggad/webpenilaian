                    ...
                    <div class="white-box">
                        ...
                        <form class="form" action="/{{ Session('user')['role'] }}/manage-karyawan" method="post"
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-10">
                                    <input class="form-control" name="nama_pegawai" type="text" value=""
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-10">
                                    <input class="form-control" name="tanggal_lahir" type="date" value=""
                                        id="example-email-input" required>
                                </div>
                            </div>
                            <div class="form-group row">
                ...
                <div class="col-sm-12">
                    <div class="white-box">
                        ...
                        @if (Session('user')['role'] == 'admin')
                            ...
                            <form class="form"
                                action="/{{ Session('user')['role'] }}/manage-karyawan/{{ Request::segment(3) }}"
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-10">
                                        <input class="form-control" name="nama_karyawan" type="text"
                                            value="{{ $karyawan->nama_pegawai }}" id="example-text-input" required>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="example-text-input" class="col-2 col-form-label">NIK</label>
                                    <div class="col-10">
                                        <input class="form-control" name="nik" type="text"
                                            value="{{ $karyawan->nik }}" id="example-text-input" required>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="example-search-input" class="col-2 col-form-label">Email</label>
                                    <div class="col-10">
                                        <input class="form-control" name="email" type="email"
                                            value="{{ $karyawan->email }}" id="example-search-input" required>
                                    </div>
                                </div>

                                <div class="form-group row">
                                    <label for="example-email-input" class="col-2 col-form-label">Tanggal Mulai
                                        Bekerja</label>
                                    <div class="col-10">
                                        <input class="form-control" name="tanggal_lahir" type="date"
                                            value="{{ \Carbon\Carbon::parse($karyawan->created_at)->format('Y-m-d') }}"
                                            id="example-email-input" required>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-10">
                                        ...
                                        <select name="jabatan_id" class="form-control" id="jabatan_id" required>
                                            @foreach ($jabatan as $list_jabatan)
                                                <option value="{{ $list_jabatan->id }}"
                                                    {{ $list_jabatan->id == $karyawan->jabatan_id ? 'selected' : '' }}>
                                                    {{ $list_jabatan->nama }}</option>
                                            @endforeach
                                        </select>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-10">
                                        <select name="divisi_id" class="form-control" id="divisi_id" required>
                                            @foreach ($divisi as $list_divisi)
                                                <option value="{{ $list_divisi->id }}"
                                                    {{ $list_divisi->id == $karyawan->divisi_id ? 'selected' : '' }}>
                                                    {{ $list_divisi->nama }}</option>
                                            @endforeach
                                        </select>
                    ...
                    @method('PUT') --}}
                            <div class="form-group row">
                                ...
                                <div class="col-10">
                                    <input class="form-control" name="nama_karyawan" type="text"
                                        value="{{ $karyawan->nama_pegawai }}" id="example-text-input" required readonly>
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="example-text-input" class="col-2 col-form-label">NIK</label>
                                <div class="col-10">
                                    <input class="form-control" name="nik" type="text"
                                        value="{{ $karyawan->nik }}" id="example-text-input" required readonly>
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="example-search-input" class="col-2 col-form-label">Email</label>
                                <div class="col-10">
                                    <input class="form-control" name="email" type="email"
                                        value="{{ $karyawan->email }}" id="example-search-input" required readonly>
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                <label for="example-email-input" class="col-2 col-form-label">Jabatan</label>
                                <div class="col-10">
                                    {{-- <input class="form-control" name="posisi" type="text" value="{{$karyawan->posisi}}" id="example-text-input" required readonly> --}}
                                    <select name="jabatan_id" class="form-control" id="jabatan_id" required readonly>
                                        @foreach ($jabatan as $list_jabatan)
                                            <option value="{{ $list_jabatan->id }}"
                                                {{ $list_jabatan->id == $karyawan->jabatan_id ? 'selected' : '' }}>
                                                {{ $list_jabatan->nama }}</option>
                            ...
                            <div class="form-group row">
                                <label for="example-email-input" class="col-2 col-form-label">Divisi</label>
                                <div class="col-10">
                                    <select name="divisi_id" class="form-control" id="divisi_id" required readonly>
                                        @foreach ($divisi as $list_divisi)
                                            <option value="{{ $list_divisi->id }}"
                                                {{ $list_divisi->id == $karyawan->divisi_id ? 'selected' : '' }}>
                                                {{ $list_divisi->nama }}</option>
